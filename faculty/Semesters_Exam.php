...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
	<li class="nav-item ">
        <a class="nav-link active" href="index.php?page=Result_Exam">All <span class="sr-only">(current)</span></a>
      </li>
	<?php
		...
		<div class="table-responsive">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$progress = $conn->query("SELECT *,concat(Course,' ',StudentID) as name FROM evaluation_list  where Class_id = $id AND Semester = '$sax'");
