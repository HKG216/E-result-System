...
<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-danger navbar-dark ">
    ...
    <?php endif; ?>
      <li>
        <a class="nav-link text-white"  href="./" role="button"> <large><b><?php echo strtoupper(ucwords($_SESSION['login_firstname'])) ?> <?php echo strtoupper(ucwords($_SESSION['login_lastname'])) ?></b></large></a>
      </li>
    </ul>
