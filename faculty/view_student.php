...
$classes = $conn->query("SELECT id,concat(curriculum) as `curriculum` FROM class_list where id = $class_id ");
$class = $classes->num_rows > 0 ? $classes->fetch_array()['curriculum'] : 'N/A';
}
?>
